...
{
    [AuthorizeRoles]
    public class StatisticsController_Copy : BaseController
    {
        ...
        public StatisticsController_Copy(ICertificateService btscertificateService, ICommonService commonService, ICertificateService certificateService, ICityService cityService, IStatisticService stattisticService, IErrorService errorService) : base(errorService)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult StatCoupleCerByOperatorArea(string Area)
        {
            List<object> chartData = new List<object>();
            try
            {
                IEnumerable<StatCoupleCerByOperatorAreaVM> ByOperator = _stattisticService.GetStatCoupleCerByOperatorArea();

                DataTable pivotTable = ByOperator.ToPivotTable(item => item.OperatorID, item => item.Area, items => items.Any() ? items.Sum(item => item.ValidCertificates) : 0);
                //DataTable pivotTable = ByOperator.ToDataTable();
                ...
                {
                    status = CommonConstants.Status_Success,
                    message = "StatCoupleCerByOperatorArea Finished !",
                    chartData = chartData
                }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception e)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult StatCoupleCerByOperatorArea1(string Area)
        {
            List<object> chartData = new List<object>();
            try
            {
                IEnumerable<StatCoupleCerByOperatorAreaVM> ByOperator = _stattisticService.GetStatCoupleCerByOperatorArea(Area);
                ...
                {
                    status = CommonConstants.Status_Success,
                    message = "StatCoupleCerByOperatorArea1 Finished !",
                    chartData = chartData
                }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception e)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult StatCoupleCerByOperatorCity(string Area)
        {
            List<object> chartData = new List<object>();
            try
            {
                ...
                DataTable pivotTable = ByOperator.ToPivotTable(item => item.OperatorID, item => item.Area, items => items.Any() ? items.Sum(item => item.ExpiredInYearCertificates) : 0);
                //DataTable pivotTable = ByOperator.ToDataTable();
                ...
                {
                    status = CommonConstants.Status_Success,
                    message = "StatCoupleCerByOperatorArea2 Finished !",
                    chartData = chartData
                }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception e)
        ...
        public ActionResult StatExpiredCerByOperatorCity(string Area)
        {
            ...
            try
            {
                IEnumerable<StatExpiredCerByOperatorCityVM> ByOperatorCity = _stattisticService.GetStatExpiredCerByOperatorCity(Area);
