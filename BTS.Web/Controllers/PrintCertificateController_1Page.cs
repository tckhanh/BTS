...
namespace BTS.Web.Areas.Controllers
{
    ...
    public class PrintCertificateController_1Page : BaseController
    {
        private ICertificateService _certificateService;
        private IOperatorService _operatorService;
        private IProfileService _profileService;

        public PrintCertificateController_1Page(ICertificateService certificateService, IOperatorService operatorService, IProfileService profileService, IErrorService errorService) : base(errorService)
        {
                            ...
                            if (ItemVm.SubBtsQuantity > SubBtsQuantityIndex)
                            {
                                ...
                                if (ItemVm.SubBtsQuantity > SubBtsQuantityIndex)
                                {
                                    ...
                                    if (ItemVm.SubBtsQuantity > SubBtsQuantityIndex)
                                    {
                                        ...
                                        if (ItemVm.SubBtsQuantity > SubBtsQuantityIndex)
                                        {
                                            ItemVm.SubBtsAntenHeight6 = SubBtsAntenHeights[SubBtsQuantityIndex];
                                            ItemVm.SubBtsAntenNum6 = SubBtsAntenNums[SubBtsQuantityIndex];
                                            ItemVm.SubBtsBand6 = SubBtsBands[SubBtsQuantityIndex];
                                            ItemVm.SubBtsCode6 = SubBtsCodes[SubBtsQuantityIndex];
                                            ItemVm.SubBtsConfiguration6 = SubBtsConfigurations[SubBtsQuantityIndex];
                                            ItemVm.SubBtsEquipment6 = SubBtsEquipments[SubBtsQuantityIndex];
                                            ItemVm.SubBtsOperatorID6 = SubBtsOperatorIDs[SubBtsQuantityIndex];
                                            ItemVm.SubBtsPowerSum6 = SubBtsPowerSums[SubBtsQuantityIndex];
                                        }
                                    }
                                }
                            }
