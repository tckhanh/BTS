var contextMenuSysController = {

    init: function () {
        contextMenuSysController.registerEventDataTable();
    },
            ...
            menu: [
                {
                    ...
                    disabled: function (event, ui) {
                        ...
                        if ($.inArray(myConstant.System_CanViewDetail_Role, myArrayRoles) > -1) {
                            return false;
                        }
                        return true;
                    }
                },
                {
                    ...
                    disabled: function (event, ui) {
                        // return `true` to disable, `"hide"` to remove entry:
                        if ($.inArray(myConstant.System_CanEdit_Role, myArrayRoles) > -1) {
                            return false;
                        }
                        return true;
                    }
                ...
                { title: "----" },
                {
                    title: "Khóa/Mở Khóa", cmd: myConstant.Action_Lock, uiIcon: "ui-icon-locked",
                    disabled: function (event, ui) {
                        // return `true` to disable, `"hide"` to remove entry:
                        if (typeof applicationUserController !== 'undefined') {
                            if ($.inArray(myConstant.System_CanLock_Role, myArrayRoles) > -1)
                                return false;
                            else
                                return true;
                        } else {
                ...
                {
                    title: "Reset mật khẩu", cmd: myConstant.Action_Reset, uiIcon: "ui-icon-gear",
                    disabled: function (event, ui) {
                        // return `true` to disable, `"hide"` to remove entry:
                        if (typeof applicationUserController !== 'undefined') {
                            if ($.inArray(myConstant.System_CanReset_Role, myArrayRoles) > -1)
                                return false;
                            else
                                return true;
                        } else {
