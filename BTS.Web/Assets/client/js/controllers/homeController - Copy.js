$(function () {
    ...
    var homeController = {
        init: function () {
            ...
            homeController.loadPieChart("/Home/StatCerByOperator", "#chart_StatCerByOperator");
            //homeController.loadPieChart("/Home/StatBtsInProcess", "#chart_StatBtsInProcess");
            homeController.loadBarChart("/Home/StatCerByOperatorArea", "#chart_StatCerByOperatorArea","Khu vực", "Giấy CNKĐ", "Nhà mạng");

            homeController.loadStackedBarChart("/Home/StatCerByOperatorCity", "#chart_StatCerByOperatorCity", "Tỉnh/ Thành phố", "Giấy CNKĐ", "Nhà mạng");
            homeController.loadBarChart("/Home/StatCerByOperatorYear", "#chart_StatCerByOperatorYear", "Năm", "Giấy CNKĐ", "Nhà mạng");

            homeController.loadPieChart("/Home/StatBtsByBand", "#chart_StatBtsByBand");
            homeController.loadPieChart("/Home/StatBtsByManufactory", "#chart_StatBtsByManufactory");

            homeController.loadStackedBarChart("/Home/StatBtsByBandCity", "#chart_StatBtsByBandCity", "Tỉnh/ Thành phố", "Số trạm BTS", "Băng tần");
            homeController.loadStackedBarChart("/Home/StatBtsByOperatorCity", "#chart_StatBtsByOperatorCity", "Tỉnh/ Thành phố", "Số trạm BTS", "Nhà mạng");
        },
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == "TimeOut") {
                        ...
                        var firstColorIndex = randomScalingFactor();
                        ...
                        for (var i in response.chartData) {
                            if (i > 1) {
                                ...
                                homeController.addDataSetBar(barChart, barChartColumNames[i - 1], newColor, barChartValues);
                            }
                        }
                    }
                    else {
                    ...
                    if (response.status == "TimeOut") {
                        ...
                        for (var i in response.chartData) {
                            if (i > 1) {
                                ...
                                homeController.addDataSetLine(stackedBarChart, stackedBarChartColumNames[i - 1], newColor, stackedBarChartValues);
                            }
                        }
                    }
                    else {
                    ...
                    if (response.status == "TimeOut") {
                        ...
                        for (var i in response.chartData) {
                            if (i > 1) {
                                ...
                                homeController.addDataSetBarLine(barLineChart, barLineChartColumNames[i - 1], newColor, barLineChartValues);
                            }
                        }
                    }
                    else {
                    ...
                    if (response.status == "TimeOut") {
                        ...
                        for (var i in response.chartData) {
                            if (i > 1) {
                                ...
                                homeController.addDataSetPie(pieChart1, pieChartColumNames[i - 1], firstColorIndex, pieChartValues1);
                            }
                        }
                    }
                    else {
                    ...
                    if (response.status == "TimeOut") {
                        ...
                        for (var i in response.chartData) {
                            if (i > 1) {
                                ...
                                homeController.addDataSetRadar(radarChart1, radarChartColumNames[i - 1], newColor, radarChartValues1);
                            }
                        }
                    }
                    else {
